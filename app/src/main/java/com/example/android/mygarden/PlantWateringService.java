...
public class PlantWateringService extends IntentService {
    ...
    // COMPLETED: Change ACTION_WATER_PLANT to ACTION_WATER_PLANT and
    ...
    public static final String PLANT_ID_EXTRA = "PLANT_ID_EXTRA";
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_WATER_PLANT.equals(action)) {
                long plantId = intent.getLongExtra(PLANT_ID_EXTRA, INVALID_PLANT_ID);
    ...
    private void handleActionWaterPlants(long plantId) {
        Uri PLANT_WITH_ID_URI = ContentUris.withAppendedId(
