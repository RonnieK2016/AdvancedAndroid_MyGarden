...
import com.example.android.mygarden.provider.PlantDbHelper;
...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // COMPLETED: Set the click handler to open the DetailActivity for plant ID,
        ...
        if(plantId != PlantContract.INVALID_PLANT_ID) {
            ...
            views.setTextViewText(R.id.plant_id_view, String.valueOf(plantId));
        }
        else {
        ...
        wateringIntent.putExtra(PlantWateringService.PLANT_ID_EXTRA, plantId);
    ...
    // COMPLETED: Modify updatePlantWidgets and updateAppWidget to pass the plant ID as well as a boolean
