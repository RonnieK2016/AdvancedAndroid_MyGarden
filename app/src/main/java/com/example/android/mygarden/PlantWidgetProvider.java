...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // COMPLETED: separate the updateAppWidget logic into getGardenGridRemoteView and getSinglePlantRemoteView
        // COMPLETED: Use getAppWidgetOptions to get widget width and use the appropriate RemoteView method
        // COMPLETED: Set the PendingIntent template in getGardenGridRemoteView to launch PlantDetailActivity
